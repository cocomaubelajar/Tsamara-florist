...
function sendWAToAll(msg) {
  const urls = [
    `https://wa.me/${MAMA_WA}?text=${encodeURIComponent(msg)}`,
    `https://wa.me/${MY_WA}?text=${encodeURIComponent(msg)}`
  ];
